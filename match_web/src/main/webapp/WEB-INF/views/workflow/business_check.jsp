    ...
    <div class="row" >
        <div class="col-sm-12" style="border-bottom: 2px #999 dashed;">
            <div class="" style="padding: 10px;">
                <span class="float_left" style="font-weight: bold;font-size: 16px">业务复核</span>
               <span class="float_right" style="margin: 0 8px;">
                   <img src="../../../static/images/toolbar/iconCheck.png" alt="">
                   <button type="button" class="none_style_button" id="checkBtn" onclick="" >复核</button>
               </span>
               <span class="float_right" style="margin: 0 8px;">
    ...
    <div class="row">
        <div class="col-sm-12">
            <form class="form-inline" role="form" style="margin:20px 0px;" onsubmit="return false;">
                ...
                <div class="form-group col-md-5">
                    <label class="col-md-4" for="begainTime">开始时间</label>
                    <input  class="form-control datepicker col-md-8" type="text" name="begainTime" id="begainTime" placeholder="开始时间">
                </div>
                <div class="form-group col-md-5">
                    <label class="col-md-4" for="endTime">结束时间</label>
                    <input  class="form-control datepicker col-md-8" type="text" name="endTime" id="endTime" placeholder="结束时间">
                </div>
    ...
    $("#checkBtn").click(function () {
        ...
        if(getSelectionsAll==""){
            ...
            layer.open({
                ...
                shadeClose: true, //点击遮罩关闭层
                area : ['800px' , '520px'],
                content: 'check/checkBusiness.do'
            });
        }else{
            alert("只能选择一条数据")
        }
