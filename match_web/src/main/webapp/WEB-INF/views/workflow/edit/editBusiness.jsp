...
<div>
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2 col-xs-2">
                <input class="form-control input-sm" type="text" placeholder="" id="mortageValue">
            </div>
...
//            zNodes=JSON.stringify(response.data);
    ...
    $("#saveBtn").click(function () {
            ajaxPart("post","/business/modifysave",'application/json;charset=UTF-8',"json",JSON.stringify({
                id:parentId,
                borrowerName:$("#borrowerName").val(),
                businessConum:$("#businessConum").val(),
                checker:$("#checker").val(),
                cooNum:$("#cooNum").val(),
                superDep:$("#superDep option:selected").val(),
    ...
    $("#submitBtn").click(function () {
        ajaxPart("post","/business/modifysubmit",'application/json;charset=UTF-8',"json",JSON.stringify({
            id:parentId,
            mor_classify:treeNodeId,
            borrowerName:$("#borrowerName").val(),
            businessConum:$("#businessConum").val(),
            checker:$("#checker").val(),
            cooNum:$("#cooNum").val(),
